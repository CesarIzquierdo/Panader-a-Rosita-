 ...
 * @author artur
 */
public class Agregar_pan extends javax.swing.JFrame {

    /**
     * Creates new form Agregar_pan
     */
    public Agregar_pan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel10.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_pan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_pan().setVisible(true);
            }
        });
    }
